                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>LeadManagementView()));
                    },
                    child: Container(
                      height: 60,
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>CustomManagementView()));
                    },
                    child: Container(
                      height: 60,
                      decoration: BoxDecoration(
                  ...
                  InkWell(
                    onTap: (){
                      ...
                      Navigator.push(context, MaterialPageRoute(builder: (context)=>ProjectAssView()));
                    },
                    child: Container(
                      height: 60,
                      decoration: BoxDecoration(
