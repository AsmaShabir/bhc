              ...
              Align(
                ...
                child: InkWell(
                            ...
                            actions: [
                              OutlinedButton(
                                style: OutlinedButton.styleFrom(
                                  side: BorderSide(color: appColors.orangee, width: 2.0), // Outline color and width
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text("Add new",style: TextStyle(color: Colors.white,fontWeight: FontWeight.w700,fontSize: 14),)),),
                ),
              ),
              SizedBox(height: h * 0.02),
              Expanded(
