            ...
            child: Form(
              ...
              child: Column( mainAxisSize: MainAxisSize.max,
                ...
                children: [
                  ...
                  Text('Login',style: GoogleFonts.roboto(color: appColors.greyy,fontSize:18,fontWeight: FontWeight.w600),),
                  ...
                  InkWell(
                      ...
                      child: Align(
                          ...
                          child: Text("Forgot password?",style: TextStyle(decoration: TextDecoration.underline,decorationColor: appColors.orangee,color:appColors.orangee,fontSize: 15,fontWeight: FontWeight.w400 )))),
                  ...
                  Row(children: [
                    ...
                    Text("Don't have an account?",style: TextStyle(color:appColors.orangee,fontSize: 15,fontWeight: FontWeight.w400 )),
                    SizedBox(width: 4,),
                    InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>ProfileCreationView()));
                        },
                        child: Text("Sign up",style: TextStyle(color:appColors.orangee,fontSize: 15,fontWeight: FontWeight.w600 ))),
                    Expanded(child: Divider()),
                  ],),
                  ...
                  Align(
                    alignment: Alignment.center,
                      child: Text('Privacy policy',style: GoogleFonts.poppins(decoration: TextDecoration.underline,decorationColor: appColors.orangee,color: appColors.orangee,fontSize: 10),)),
                  ...
                  Align(
                      ...
                      child: Text('Terms of service',style: GoogleFonts.poppins(decoration: TextDecoration.underline,decorationColor: appColors.orangee,color: appColors.orangee,fontSize: 10),))
